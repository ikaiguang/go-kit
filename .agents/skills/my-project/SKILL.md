---
name: my-project
description: my-project 仓库专用工作指引。该仓库是基于 go-kratos、DDD 分层和 Wire 的微服务工具包。当需要在本仓库中实现、重构、评审或排查 Go 代码，修改 Proto、service、biz、data、Wire 装配，或查找本仓库特有的命令、架构、日志和错误处理约定时使用。
---
